        ...
        <div class="body">
            ...
            <div class="rightframe">
                <?php
                    ...
                    for($i=1; $i<=6; $i=$i+1)
                    {   if($i==1){
                            echo " <center><h3>Chocolate Cakes</h3></center>";
                        }
                        elseif($i==2){
                            echo " <center><h3>Strawberry Cakes</h3></center>";
                        }
                        elseif($i==4){
                            echo " <center><h3>Birthday Cakes</h3></center>";
                        }
                        elseif($i==5){
                            echo " <center><h3>Cartoons Cakes</h3></center>";
                        }
                        elseif($i==6){
                            echo " <center><h3>Anniversary Cakes</h3></center>";
                        }
                        ...
                        if($i==3){
                            ...
                            $sql="SELECT * FROM tblproducts a WHERE a.category_id=$i;";
                            $res=mysqli_query($conn2,$sql);
                            echo '<center><table border=2 cellspacing=0>
                            <tr><th>Product Code</th><th>Cakes Name</th><th>Available</th><th>Price</th></tr>';
