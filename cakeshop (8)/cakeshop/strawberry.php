...
<!-- <div class="row">
      ...
      $query = "SELECT * FROM tblproducts WHERE status='available' AND category_id=2 ";
        ...
        <div class="card mb-3">
          <div class="card-body">
            <form method="post" action="index.php?action=add&id=<?php echo $row["product_code"]; ?>">
              <center><img src="Strawberry_cakes/<?php echo $row['product_id']?>.png" style="width: 100px">                
    ...
    <div class="main">
        ...
        <div class="cake">
            ...
            <div class="cake_img">
                <img src="Images/<?php echo $row['product_id'];?>.png" style="width: 100%">               
            </div>
    ...
    <!-- <div class="container">
        <div class="cake">
            <div class="cake_img">
                ...
                <img src="strawberry_cakes/mouth_watering.jfif" alt="">
                
            </div>
            <div class="description">
                <small>Mouth Watering Starwberry</small> <br>
                <small>$Price</small>
            </div>
        </div>
        <div class="cake">
            <div class="cake_img">
                ...
                <img src="strawberry_cakes/Floral.png" alt="">
                
            </div>
            <div class="description">
                <small>Floral Strawberry</small> <br>
                <small>$Price</small>
            </div>
        </div>
        <div class="cake">
            <div class="cake_img">
                ...
                <img src="strawberry_cakes/premium.webp" alt="">
                
            </div>
            <div class="description">
                <small>Premium Starwberry</small> <br>
                <small>$Price</small>
            </div>
        </div>
        <div class="cake">
            <div class="cake_img">
                ...
                <img src="strawberry_cakes/strawberry.jpg" alt="">
                
            </div>
            <div class="description">
                <small>Strawberry Cake</small> <br>
                <small>$Price</small>
            </div>
        </div>
        <div class="cake">
            <div class="cake_img">
                ...
                <img src="strawberry_cakes/hearty.webp" alt="">
                
            </div>
            <div class="description">
                <small>Hearty Strawberry</small> <br>
                <small>$Price</small>
            </div>
        </div>
        <div class="cake">
            <div class="cake_img">
                ...
                <img src="strawberry_cakes/red_glaze.webp" alt="">
                
            </div>
            <div class="description">
                <small>Red Glaze Strawberry</small> <br>
                <small>$Price</small>
            </div>
        </div>
        <div class="cake">
            <div class="cake_img">
                ...
                <img src="strawberry_cakes/satin.jpg" alt="">
                
            </div>
            <div class="description">
                <small>Satin Strawberry</small> <br>
                <small>$Price</small>
            </div>
        </div>
        <div class="cake">
            <div class="cake_img">
                ...
                <img src="strawberry_cakes/creamy_st.jpg" alt="">
                
            </div>
            <div class="description">
                <small>Creamy Strawberry</small> <br>
                <small>$Price</small>
            </div>
        </div>
        <div class="cake">
            <div class="cake_img">
                ...
                <img src="strawberry_cakes/pink_st.jfif" alt="">
                
            </div>
            <div class="description">
                <small>Pink Strawberry</small> <br>
                <small>$Price</small>
            </div>
        </div>
        <div class="cake">
            <div class="cake_img">
                ...
                <img src="strawberry_cakes/creamy_strawberry_heart.jfif" alt="">
                
            </div>
            <div class="description">
                <small>Creamy Strawberry Heart</small> <br>
                <small>$Price</small>
            </div>
        </div>
        <div class="cake">
            <div class="cake_img">
                ...
                <img src="strawberry_cakes/Pink_strawberry_cream.jpg" alt="">
                
            </div>
            <div class="description">
                <small>Pink Strawberry Cream</small> <br>
                <small>$Price</small>
            </div>
        </div>
        <div class="cake">
            <div class="cake_img">
                ...
                <img src="strawberry_cakes/satrawberry_almond_birthday.jfif" alt="">
                
            </div>
            <div class="description">
                <small>Strawberry Almond Birthday Cake</small> <br>
                <small>$Price</small>
            </div>
        </div>
